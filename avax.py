...
# Configuration
INFURA_URL = os.getenv('AVAX_RPC')  # Replace with your Infura URL or another Ethereum node provider URL
...
START_BLOCK = 45114227  # Block number to start monitoring from
...
def handle_event(event):
    ...
    message = (f"New ETH Token Created:\n"
               ...
               f"Address: [{token_address}](https://snowtrace.io/address/{token_address})")
