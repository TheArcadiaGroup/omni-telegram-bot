...
# Configuration
INFURA_URL = os.getenv('ARB_RPC')  # Replace with your Infura URL or another Ethereum node provider URL
CONTRACT_ADDRESS = "0xFE38051D161f992C95386732A883DC5Cb15d9B20"
...
START_BLOCK = 208516776  # Block number to start monitoring from
...
def handle_event(event):
    ...
    message = (f"New ARB Token Created:\n"
               f"Name: {name}\n"
               f"Symbol: {symbol}\n"
               f"Total Supply: {total_supply}\n"
               f"Address: [{token_address}](https://arbiscan.io//address/{token_address})")
